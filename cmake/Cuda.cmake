...
function(op_select_nvcc_arch_flags out_variable)
  # List of arch names
  set(__archs_names "Volta (CUDA >= 9)" "Turing (CUDA >= 10)" "Ampere (CUDA >= 11)" "Ada (CUDA = 11.7)" "Hopper (CUDA >= 12)" "All" "Manual")
  # set(__archs_names "Volta (CUDA >= 9)" "Turing (CUDA >= 10)" "Ampere (CUDA >= 11)" "Ada (CUDA = 11.7)" "Hopper (CUDA >= 12)" "All" "Manual"vim)
  ...
  if (${CUDA_ARCH} STREQUAL "Volta (CUDA >= 9)")
    set(__cuda_arch_bin ${VOLTA})
  elseif (${CUDA_ARCH} STREQUAL "Turing (CUDA >= 10)")
    set(__cuda_arch_bin ${TURING})
  elseif (${CUDA_ARCH} STREQUAL "Ampere (CUDA >= 11)")
    set(__cuda_arch_bin ${AMPERE})
  elseif (${CUDA_ARCH} STREQUAL "Ada (CUDA = 11.7)")
    set(__cuda_arch_bin ${ADA})
  elseif (${CUDA_ARCH} STREQUAL "Hopper (CUDA >= 12)")
